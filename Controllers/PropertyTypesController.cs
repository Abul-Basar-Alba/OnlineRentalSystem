...
namespace OnlineRentalSystem.Controllers
{
    public class PropertyTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PropertyTypeId,Name,Description")] PropertyType propertyType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("PropertyTypeId,Name,Description")] PropertyType propertyType)
        {
